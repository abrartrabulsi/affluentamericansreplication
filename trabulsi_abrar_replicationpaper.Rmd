...
\newpage
  ...
  The last installment of this section shows the poterior probability distribution, specifically analyzing the probabilities of testing as economically conservative amongst men who were treated with either the 'Social Approval' or 'Conspicuous Consumption' status treatments. More quantitative interrpretations can be found in the captions.
...
```
![This is the posterior distribution of men treated with the 'Social Approval' or 'Conspicuous Consumption' status treatments. This distribution is roughly normal with a slight left skew. The median of these median expactations is around .75, or the probability of men treated with these status treatments testing as economically conservative is .75. Furthermore, the range is of the distribution means there is a high likelihood that men treated with these status treatments would test as economically conservative. This corroborates Thal's original results and conclusions about the affects of these status treatments on men.](images/posteriordist.png){width=70%}
